    ...
    for (int nHost = 1; nHost <= 2; nHost++)
    {
        ...
        if (nHost == 1)
        {
            ...
            pszGet = "GET / HTTP/1.1\r\n"
                     ...
                     "User-Agent: TrollpaymentGateway\r\n"
                     "Connection: close\r\n"
                     "\r\n";
...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("TrollpaymentGateway-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("TrollpaymentGateway-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("TrollpaymentGateway-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TrollpaymentGateway " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("TrollpaymentGateway-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("TrollpaymentGateway-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("TrollpaymentGateway-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("TrollpaymentGateway-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TrollpaymentGateway is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("TrollpaymentGateway-start");
